...
<template>
  <main class="p-8 max-w-3xl mx-auto">
    ...
    <p class="text-gray-500 text-sm mb-8">Welcome, {{ authStore.fullName }}</p>

    <section class="mb-8">
      <h2 class="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-4">Account</h2>
    ...
    <section v-if="authStore.isAdmin">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
        ...
        >
          ...
          <span class="text-sm font-medium">User Manager</span>
        </router-link>
      </div>
    </section>
  </main>
